...
namespace MathServiceTests.EstimatorsTests.Tests.WeightedMean
{
    ...
    public class EstimatorsTests_WeightedMean_1
    {
        ...
        {
            double result = Estimators.WeightedMean(Data_1.TestData, 0, 0).X;
            Assert.AreEqual(10.1922, result);
        }
        [TestMethod]
        public void WeightedMean_U_test_2_DEF()
        {
            double result = Estimators.WeightedMean(Data_1.TestData, 0, 0).U;
        ...
        public void Mean_X_test_3_Calibration()
        {
            ...
            double result = Estimators.WeightedMean(Data_1.TestData, weighted_mean_iteration_calibr, weighted_mean_result_calibr).X;
        ...
        public void Mean_U_test_4_Calibration()
        {
            ...
            double result = Estimators.WeightedMean(Data_1.TestData, weighted_mean_iteration_calibr, weighted_mean_result_calibr).U;
